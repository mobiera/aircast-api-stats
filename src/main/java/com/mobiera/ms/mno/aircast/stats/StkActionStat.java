...
public enum StkActionStat implements StatEnum {
	...
	private StkActionStat(Integer index, String label, String description, Boolean showByDefault){
		this.index = index;
		this.label = label;
	...
	public static StkActionStat getEnum(Integer index){
		if (index == null)
	return null;
