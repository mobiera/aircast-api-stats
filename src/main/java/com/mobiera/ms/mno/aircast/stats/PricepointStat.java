...
public enum PricepointStat implements StatEnum {
...
SUBSCRIBE(52, "Subscribe", true),
	...
	private PricepointStat(Integer index, String label, Boolean showByDefault){
		this.index = index;
		this.label = label;
	...
	public static PricepointStat getEnum(Integer index){
		if (index == null)
	return null;
