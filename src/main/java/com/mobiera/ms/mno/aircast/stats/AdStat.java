...
public enum AdStat implements StatEnum {
	...
	private AdStat(Integer index, String label, String description, Boolean showByDefault){
		this.index = index;
		this.label = label;
	...
	public static AdStat getEnum(Integer index){
		if (index == null)
	return null;
