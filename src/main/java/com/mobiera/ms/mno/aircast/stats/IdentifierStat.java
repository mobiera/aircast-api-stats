...
public enum IdentifierStat implements StatEnum {
	...
	private IdentifierStat(Integer index, String label, Boolean showByDefault){
		this.index = index;
		this.label = label;
	...
	public static IdentifierStat getEnum(Integer index){
		if (index == null)
	return null;
