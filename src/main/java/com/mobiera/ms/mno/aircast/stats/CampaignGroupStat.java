...
public enum CampaignGroupStat implements StatEnum {
	...
	private CampaignGroupStat(Integer index, String label, Boolean showByDefault){
		this.index = index;
		this.label = label;
	...
	public static CampaignGroupStat getEnum(Integer index){
		if (index == null)
	return null;
		switch(index){
