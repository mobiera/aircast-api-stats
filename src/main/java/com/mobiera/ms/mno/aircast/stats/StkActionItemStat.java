...
public enum StkActionItemStat implements StatEnum {
	...
	private StkActionItemStat(Integer index, String label, String description, Boolean showByDefault){
		this.index = index;
		this.label = label;
	...
	public static StkActionItemStat getEnum(Integer index){
		if (index == null)
	return null;
