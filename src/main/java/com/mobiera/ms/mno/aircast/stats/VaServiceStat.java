...
public enum VaServiceStat implements StatEnum {
	...
	private VaServiceStat(Integer index, String label, Boolean showByDefault){
		this.index = index;
		this.label = label;
	...
	public static VaServiceStat getEnum(Integer index){
		if (index == null)
	return null;
