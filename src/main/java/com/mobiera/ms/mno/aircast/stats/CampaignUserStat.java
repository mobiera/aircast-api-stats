...
public enum CampaignUserStat implements StatEnum {
	...
	private CampaignUserStat(Integer index, String label, Boolean showByDefault){
		this.index = index;
		this.label = label;
	...
	public static CampaignUserStat getEnum(Integer index){
		if (index == null)
	return null;
		switch(index){
